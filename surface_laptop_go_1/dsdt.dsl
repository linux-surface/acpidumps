 ...
 *
 * Disassembly of dsdt.dat, Sun Nov  8 16:05:24 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001A541 (107841)
 *     Revision         0x02
 *     Checksum         0xC4
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000002)
{
                ...
                If ((Arg0 == ToUUID ("4993a436-e1ac-4dc7-b4f8-46a5008fb9e7") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == One))
                    {
                        If ((Arg1 == Zero))
                        {
                            Local0 = Package (0x08)
                                {
                                    "SYSTEM_5P0_KBTP_FAN_AUDIO_USBVBUS", 
                                    0x05, 
                                    "SYSTEM_3P3_CAMERA_TOUCH_PANEL", 
                                    0x0A, 
                                    "STORAGE", 
                                    0x14, 
                                    "WIFI_BLUETOOTH", 
    ...
    Scope (_GPE)
    {
        Method (_L26, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            If ((OMBR >= 0x02))
            {
                ...
                If ((\_SB.GGIV (0x06030006) == Zero))
                {
                    \_SB.SGII (0x06030006, Zero)
                    Local0 = One
                }
                Else
                {
                    \_SB.SGII (0x06030006, One)
                    Local0 = Zero
                }
    ...
    Scope (_SB.PCI0.I2C4)
    {
        Device (ALSD)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (RBUF) /* \_SB_.PCI0.I2C4.ALSD.RBUF */
            }
    ...
    Scope (_SB.PCI0.I2C2)
    {
        Device (TPL1)
        {
            Name (_HID, "MELF0411")  // _HID: Hardware ID
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (RBUF) /* \_SB_.PCI0.I2C2.TPL1.RBUF */
            }
    ...
    Scope (_SB.PCI0.I2C0)
    {
        Device (TROM)
        {
            ...
            Name (_CID, "OEQNTCON")  // _CID: Compatible ID
            Name (_S0W, 0x03)  // _S0W: S0 Device Wake State
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If ((MANF == Zero))
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    ...
                    I2cSerialBusV2 (0x0050, ControllerInitiated, 0x000F4240,
                        AddressingMode7Bit, "\\_SB.PCI0.I2C0",
                        0x00, ResourceConsumer, , Exclusive,
                        )
                })
                Return (RBUF) /* \_SB_.PCI0.I2C0.TROM._CRS.RBUF */
            }
                ...
                If ((Arg0 == ToUUID ("7a0ae771-9cdd-4a77-958f-5d1c79cfe1b7") /* Unknown UUID */))
                {
                    ...
                    If ((Arg1 == Zero))
                    {
                        ...
                        If ((Arg2 == 0x03))
                        {
                            ...
                            CAL5 = 0x0100
                            CRC5 = Zero
                            Return (CALO) /* \_SB_.PCI0.I2C0.TROM._DSM.CALO */
                        }
                        Else
                        {
                            Return (Buffer (One)
