 ...
 *
 * Disassembly of ssdt2.dat, Sun Nov  8 16:05:25 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.GFX0.CPSC, UnknownObj)
    External (_SB_.PCI0.GFX0.DSEN, UnknownObj)
    External (_SB_.PCI0.GFX0.HDOS, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GFX0.HNOT, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.GFX0.OSYS, IntObj)
    External (_SB_.PCI0.GFX0.PCHN, UnknownObj)
    External (_SB_.PCI0.GFX0.PCHS, UnknownObj)
    External (_SB_.PCI0.GFX0.S0ID, UnknownObj)
    ...
    OperationRegion (SANV, SystemMemory, 0x7BBAA018, 0x01F4)
