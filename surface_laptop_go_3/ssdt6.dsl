 ...
 *
 * Disassembly of ssdt6.dat, Thu Oct 19 19:02:46 2023
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000105E (4190)
 *     Revision         0x02
 *     Checksum         0x28
 *     OEM ID           "OEMID "
...
DefinitionBlock ("", "SSDT", 2, "OEMID ", "SsdtSurf", 0x00001000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x55B44000, 0x0043)
    ...
    Scope (\_SB.PC00.I2C5)
    {
        Device (TPL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (RBUF) /* \_SB_.PC00.I2C5.TPL1.RBUF */
            }
