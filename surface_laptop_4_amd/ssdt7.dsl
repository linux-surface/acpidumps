 ...
 *
 * Disassembly of ssdt7.dat, Thu Apr 22 15:56:06 2021
 *
...
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            OperationRegion (TNVS, SystemMemory, 0x7C794000, 0x2F)
            ...
            Name (RES0, ResourceTemplate ()
            {
                ...
                Interrupt (ResourceConsumer, Level, ActiveLow, Shared, ,, _Y05)
                {
                    0x0000000C,
                }
            })
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Else
                {
                    CreateDWordField (RES0, \_SB.TPM._Y05._INT, LIRQ)  // _INT: Interrupts
            ...
            Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
            {
                If ((IRQN != Zero))
                {
                    ...
                    CreateBitField (RES0, \_SB.TPM._Y05._HE, LTRG)  // _HE_: High-Edge
                    LTRG = ITRG /* \_SB_.TPM_._SRS.ITRG */
                    CreateBitField (Arg0, 0x7A, ILVL)
                    CreateBitField (RES0, \_SB.TPM._Y05._LL, LLVL)  // _LL_: Low Level
