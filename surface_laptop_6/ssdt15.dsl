 ...
 */
DefinitionBlock ("", "SSDT", 2, "OEMML ", "SsdtSurf", 0x00001000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x59F48000, 0x0043)
    ...
    Scope (\_SB)
    {
        Device (SSH)
        {
            ...
            CreateDWordField (SBUF, \_SB.SSH._Y50._SPE, BAUD)  // _SPE: Speed
