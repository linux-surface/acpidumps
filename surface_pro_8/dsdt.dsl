 ...
 *
 * Disassembly of dsdt.dat, Wed Oct 27 00:50:19 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001A781 (108417)
 *     Revision         0x02
 *     Checksum         0xC8
 *     OEM ID           "INTEL"
 *     OEM Table ID     "TGL     "
...
DefinitionBlock ("", "DSDT", 2, "INTEL", "TGL     ", 0x00000000)
{
    ...
    OperationRegion (FNVS, SystemMemory, 0x7DB93000, 0x000F)
    ...
    Scope (\)
    {
        ...
        Name (SS3, Zero)
        Name (SS4, One)
        OperationRegion (GNVS, SystemMemory, 0x7DB95000, 0x0AB5)
    ...
    Scope (_SB.PC00.I2C2)
    {
        Device (CAMF)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PC00.I2C2.CAMF._CRS.SBUF */
            }
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x04, 0x02, 0x00, 0x00,  // ........
                    ...
                    /* 0050 */  0x0C, 0x01, 0x02, 0x01, 0x00, 0x01, 0x00, 0xF8,  // ........
                    /* 0058 */  0x24, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,  // $.......
                    /* 0060 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0068 */  0x00, 0x00, 0x00, 0x00                           // ....
                })
                Return (PAR) /* \_SB_.PC00.I2C2.CAMF.SSDB.PAR_ */
            }
        ...
        Device (ICL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PC00.I2C2.ICL1._CRS.SBUF */
            }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                ...
                {
                    /* 0000 */  0x00, 0x01, 0x01, 0x20, 0x00, 0x0C, 0x01, 0x00,  // ... ....
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
                Return (PAR) /* \_SB_.PC00.I2C2.ICL1.CLDB.PAR_ */
            }
    ...
    Scope (_SB.PC00.I2C3)
    {
        Device (CAMR)
        {
            ...
            Name (_DDN, "OV13858-CRDD")  // _DDN: DOS Device Name
            Method (_SUB, 0, NotSerialized)  // _SUB: Subsystem ID
            {
                Return (GCSM (0x02))
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PC00.I2C3.CAMR._CRS.SBUF */
            }
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00,  // ........
                    /* 0020 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0028 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0030 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0038 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0040 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0048 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09, 0x11,  // ........
                    /* 0050 */  0x0C, 0x01, 0x02, 0x01, 0x00, 0x01, 0x00, 0xF8,  // ........
                    /* 0058 */  0x24, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // $.......
                    /* 0060 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0068 */  0x00, 0x00, 0x00, 0x00                           // ....
                })
                Return (PAR) /* \_SB_.PC00.I2C3.CAMR.SSDB.PAR_ */
            }
        ...
        Device (ICL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PC00.I2C3.ICL0._CRS.SBUF */
            }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x20)
                {
                    /* 0000 */  0x00, 0x01, 0x00, 0x20, 0x00, 0x0C, 0x01, 0x00,  // ... ....
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
                Return (PAR) /* \_SB_.PC00.I2C3.ICL0.CLDB.PAR_ */
            }
    ...
    Scope (_SB.PC00.I2C3)
    {
        Device (CAM3)
        {
            ...
            Name (_CID, "SMO55F0")  // _CID: Compatible ID
            Name (_DDN, "VD55G0-CRDD")  // _DDN: DOS Device Name
            Method (_SUB, 0, NotSerialized)  // _SUB: Subsystem ID
            {
                Return (GCSM (0x03))
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PC00.I2C3.CAM3._CRS.SBUF */
            }
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x05, 0x01, 0x00, 0x00,  // ........
                    /* 0020 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0028 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0030 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0038 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    ...
                    /* 0050 */  0x0C, 0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x36,  // .......6
                    /* 0058 */  0x6E, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,  // n.......
                    /* 0060 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0068 */  0x00, 0x00, 0x00, 0x00                           // ....
                })
                Return (PAR) /* \_SB_.PC00.I2C3.CAM3.SSDB.PAR_ */
            }
        ...
        Device (ICL2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PC00.I2C3.ICL2._CRS.SBUF */
            }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x20)
                {
                    /* 0000 */  0x00, 0x01, 0x02, 0x20, 0x00, 0x0C, 0x01, 0x00,  // ... ....
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
                Return (PAR) /* \_SB_.PC00.I2C3.ICL2.CLDB.PAR_ */
            }
