 ...
 *
 * Disassembly of ssdt4.dat, Wed Oct 27 00:50:19 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001219 (4633)
 *     Revision         0x02
 *     Checksum         0xF9
 *     OEM ID           "MSFT  "
...
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "SsdtSurf", 0x00001000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x7DB92000, 0x0043)
    ...
    Scope (\_SB.PC00.I2C0)
    {
        Device (SROM)
        {
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("320243bf-f16f-48e6-b322-274dd5c225b9") /* Unknown UUID */))
                {
                    If ((Arg2 == Zero))
                    {
                        If ((Arg1 == Zero))
                    ...
                    If ((Arg1 == Zero))
                    {
                        ...
                        If ((Arg2 == 0x02))
                        {
                            Return (CSBS) /* \_SB_.PC00.I2C0.SROM.CSBS */
                        }
