 ...
 *
 * Disassembly of dsdt.dat, Thu Jul  7 12:42:56 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001995E (104798)
 *     Revision         0x02
 *     Checksum         0x4B
 *     OEM ID           "INTEL"
 *     OEM Table ID     "TGL     "
...
DefinitionBlock ("", "DSDT", 2, "INTEL", "TGL     ", 0x00000000)
{
    ...
    Name (SCAP, 0x0000000000001F8F)
    OperationRegion (FNVS, SystemMemory, 0x95B95000, 0x000F)
    ...
    Scope (\)
    {
        ...
        Name (SS3, Zero)
        Name (SS4, One)
        OperationRegion (GNVS, SystemMemory, 0x95B97000, 0x0ABC)
