 ...
 *
 * Disassembly of ssdt10.dat, Thu Jul  7 12:42:56 2022
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000FD5 (4053)
 *     Revision         0x02
 *     Checksum         0xDA
 *     OEM ID           "OEMID "
...
DefinitionBlock ("", "SSDT", 2, "OEMID ", "SsdtSurf", 0x00001000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x95B94000, 0x0043)
    ...
    Scope (\_SB)
    {
        Device (SSH)
        {
            ...
            CreateDWordField (SBUF, \_SB.SSH._Y3A._SPE, BAUD)  // _SPE: Speed
    ...
    Scope (\_SB.PC00.I2C2)
    {
        Device (TPL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (RBUF) /* \_SB_.PC00.I2C2.TPL1.RBUF */
            }
