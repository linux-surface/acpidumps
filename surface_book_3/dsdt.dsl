...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000002)
{
    ...
    External (_SB_.PCI0.RP13.MRGT, MethodObj)    // 1 Arguments
    ...
    Scope (_GPE)
    {
        ...
        Method (_L61, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            If (((\_SB.PCI0.RP13.PDID != 0xFFFFFFFF) && \_SB.PCI0.RP13.HPSS))
            {
                Debug = "_GPE L61 RP13\n"
                UDB0 ("_GPE L61 RP13\n")
                \_SB.PCI0.RP13.PDC = One
                \_SB.PCI0.RP13.LLSC = One
                \_SB.PCI0.RP13.HPSS = One
            }
    ...
    Scope (_GPE)
    {
        Method (_L4D, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            If ((LIDS != Local0))
            {
                ...
                Notify (\_SB.SHPS, 0x83) // Device-Specific Change
        ...
        {
            ADBG ("GPE_ASL_HANDLER_CANVAS_CLOSED")
            If ((\_SB.GGIV (0x0605000B) == Zero))
            {
                \_SB.SGII (0x0605000B, Zero)
                Local0 = Zero
            }
            Else
            {
                \_SB.SGII (0x0605000B, One)
                Local0 = One
            }
    ...
    Scope (_SB.PCI0.RP13.PXSX)
    {
        ...
        Method (MGPS, 4, Serialized)
        {
            Switch (Arg2)
            {
                ...
                Case (0x22)
                {
                    ...
                    CPPC = PCAP /* \_SB_.PCI0.RP13.PXSX.MGPS.PCAP */
                    ...
                    PSAP = PCAP /* \_SB_.PCI0.RP13.PXSX.MGPS.PCAP */
                    Return (PCAP) /* \_SB_.PCI0.RP13.PXSX.MGPS.PCAP */
                }
                Case (0x23)
                {
                    UDB0 ("[HG._DSM.GPS] - GPS_FUNC_GETPPC\n")
                    Return (PSAP) /* \_SB_.PCI0.RP13.PXSX.PSAP */
                }
                Case (0x2A)
                {
                    ...
                    Switch (PSH0)
                    {
                        Case (Zero)
                        {
                            ...
                            Return (GPSP) /* \_SB_.PCI0.RP13.PXSX.GPSP */
                        }
                        Case (One)
                        {
                            RETN = One
        ...
        Method (MGC6, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (One)
                {
                    ...
                    GC6V = 0x02
                    JTRV = 0x0200
                    Return (JTCA) /* \_SB_.PCI0.RP13.PXSX.MGC6.JTCA */
                }
                Case (0x02)
                {
                ...
                Case (0x03)
                {
                    ...
                    If ((ToInteger (DFGC) != Zero))
                    {
                        GPWO = One
                        GUPS = One
                        Return (JTPC) /* \_SB_.PCI0.RP13.PXSX.MGC6.JTPC */
                    }
        ...
        Method (GC6I, 0, Serialized)
        {
            Debug = "   JT GC6I"
            UDB0 ("GC6I Entry\n")
            TMM1 = LTME /* \_SB_.PCI0.RP13.LTME */
            L23I ()
            Sleep (0x0A)
            SGOV (0x0607000C, Zero)
        }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            L23O ()
            CMDR |= 0x04
            LTME = TMM1 /* \_SB_.PCI0.RP13.PXSX.TMM1 */
            CEDR = One
        }
        ...
        Method (MOPT, 4, Serialized)
        {
            ...
            Switch (Arg2)
            {
                ...
                Case (0x1B)
                {
                    ...
                    If ((APCV == One))
                    {
                        ACNT = APPC /* \_SB_.PCI0.RP13.PXSX.MOPT.APPC */
                        ...
                        Else
                        {
                            ...
                            Notify (SGPC, 0x81) // Information Change
                        }
                    }
    ...
    Scope (_SB.PCI0.RP13)
    {
        Name (POTO, Zero)
        Name (GPST, Zero)
        OperationRegion (RPCX, SystemMemory, 0xE00EC000, 0x1000)
        ...
        PowerResource (PRPD, 0x00, 0x0000)
        {
            ...
            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                ...
                If ((^^PXSX.TDGC == One))
                {
                    If (((^^PXSX.DGCX == 0x03) || (^^PXSX.DGCX == 0x04)))
                    {
                        ^^PXSX.GC6O ()
                    }
            ...
            {
                UDB0 ("[RP13._OFF] Entry\n")
                Notify (SGPC, 0x80) // Status Change
                If ((^^PXSX.TDGC == One))
                {
        ...
        Method (HGON, 0, Serialized)
        {
            ...
            Else
            {
                SGOV (0x0607000C, Zero)
                SGOV (0x0605000E, One)
                Local0 = WPGS (0x0605000F, One, 0x0C80)
                If ((Zero == Local0))
                {
        ...
        Method (HGOF, 0, Serialized)
        {
            ...
            If ((GGIV (GPST) == One))
            {
                SGOV (0x0607000C, Zero)
                Sleep (0x0A)
                SGOV (0x0605000E, Zero)
                Local0 = WPGS (0x0605000F, Zero, 0x0C80)
                If ((Zero == Local0))
                {
    ...
    Scope (_SB.PCI0.RP13.PXSX)
    {
        ...
        Method (NBCI, 4, Serialized)
        {
            ...
            If ((Arg2 == 0x10))
            {
                ...
                If ((BFF0 == 0x4452))
                {
                    Return (GSDR) /* \_SB_.PCI0.RP13.PXSX.GSDR */
                }
            }
    ...
    Scope (_SB)
    {
        Scope (SHPS)
        {
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((BTYP >= 0x03))
                {
                    Return (SBU2) /* \_SB_.SHPS._CRS.SBU2 */
                }
                Else
                {
                ...
                If ((Arg0 == ToUUID ("5515a847-ed55-4b27-8352-cd320e10360a") /* Unknown UUID */))
                {
                    If ((ToInteger (Arg1) == One))
                    {
                        ...
                        If ((ToInteger (Arg2) == 0x04))
                        {
                            ...
                            {
                                If ((0xFF == ^^PCI0.RP13.POTO))
                                {
                                    ^^PCI0.RP13.HGO2 ()
                                    Notify (^^PCI0.RP13, One) // Device Check
                                }
                            }
