 ...
 *
 * Disassembly of dsdt.dat, Sun Aug 11 07:44:42 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000169D4 (92628)
 *     Revision         0x02
 *     Checksum         0xDC
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    Name (SS3, Zero)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8BEA5000, 0x0734)
        ...
        Device (BAT1)
        {
            ...
            Method (PMAX, 0, Serialized)
            {
                ...
                ElseIf ((SizeOf (Local0) == 0x04))
                {
                    ...
                    UDB1 ("PMAX: field type=%0\n", ObjectType (_DR3))
                    Local2 = _DR3 /* \_SB_.BAT1.PMAX._DR3 */
                    UDB1 ("PMAX= %0X\n", Local2)
                }
                Else
                {
                    UDB2 ("PMAX: _SAN.RQST len error %0 (expected %1)\n", SizeOf (Local0), 0x04)
                }
    ...
    Scope (_SB)
    {
        ...
        Device (VGBI)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((OMBR < 0x04))
                {
                    CreateWordField (SBUF, 0x17, PGIP)
                    CreateWordField (SBUF, 0x3F, PGPP)
                    PGIP = 0x32
                    PGPP = 0x32
                }
