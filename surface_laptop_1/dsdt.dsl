...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    External (_SB_._SAN.GENC, DeviceObj)
    External (_SB_._SAN.GEND, DeviceObj)
    External (_SB_._SAN.GENE, DeviceObj)
    External (_SB_._SAN.GENF, DeviceObj)
    External (_SB_._SAN.GENG, DeviceObj)
    ...
    Scope (_SB)
    {
        Device (_SHM)
        {
            ...
            Name (_HID, "MSHW0096")  // _HID: Hardware ID
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (((GGIV (0x02050015) == Zero) || (GGIV (0x02040010) == One)))
                {
                    Debug = "_SHM._STA(1)\n"
                    UDB0 ("_SHM._STA(1)\n")
                    Return (0x0F)
    ...
    Scope (_SB)
    {
        Device (_SAN)
        {
                    ...
                    If ((Arg1 == Zero))
                    {
                        Switch (Arg2)
                        {
                            ...
                            Case (0x09)
                            {
                                ...
                                ElseIf ((ToInteger (Arg3) == 0x0C))
                                {
                                    If (CondRefOf (\_SB._SAN.GENC))
                                    {
                                        Notify (GENC, 0x90) // Device-Specific
                                    }
                                }
                                ElseIf ((ToInteger (Arg3) == 0x0D))
                                {
                                    If (CondRefOf (\_SB._SAN.GEND))
                                    {
                                        Notify (GEND, 0x90) // Device-Specific
                                    }
                                }
                                ElseIf ((ToInteger (Arg3) == 0x0E))
                                {
                                    If (CondRefOf (\_SB._SAN.GENE))
                                    {
                                        Notify (GENE, 0x90) // Device-Specific
                                    }
                                }
                                ElseIf ((ToInteger (Arg3) == 0x0F))
                                {
                                    If (CondRefOf (\_SB._SAN.GENF))
                                    {
                                        Notify (GENF, 0x90) // Device-Specific
                                    }
                                }
                                ElseIf ((ToInteger (Arg3) == 0x10))
                                {
                                    If (CondRefOf (\_SB._SAN.GENG))
                                    {
                                        Notify (GENG, 0x90) // Device-Specific
                                    }
                                }
                            }
                            Case (0x0A)
            ...
            {
                Return (RQSX (Arg0, Arg1, Arg2, Arg3, Arg4, One, One))
            }

            Method (RQSG, 5, Serialized)
            {
                Return (RQSX (Arg0, Arg1, Arg2, Arg3, Arg4, 0x03, One))
            }

            Method (RQSC, 6, Serialized)
            {
                Return (RQSX (Arg0, Arg1, Arg2, Arg3, Arg4, One, Arg5))
            }

            Method (RQSX, 7, Serialized)
            {
                Local4 = One
                If ((AVBL == One))
                {
                ...
                If ((Arg0 == ToUUID ("6fd05c69-cde3-49f4-95ed-ab1665498035") /* Unknown UUID */))
                {
                    If ((One == ToInteger (Arg1)))
                    {
                        Switch (ToInteger (Arg2))
                        {
                            ...
                            Case (0x02)
                            {
                                UDB0 ("VGBI._DSM: Query OEM Platform ID\n")
                                Return (OMPR) /* \OMPR */
                            }
    ...
    Scope (_SB.PCI0.I2C0)
    {
        Device (TPD2)
        {
            Name (_HID, "MSHW0092")  // _HID: Hardware ID
    ...
    Scope (_SB.PCI0.I2C3)
    {
        Device (ALSD)
        {
            Name (_HID, "LSD9033")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_S0W, 0x03)  // _S0W: S0 Device Wake State
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
            ...
            CreateWordField (CRS2, 0x17, INT1)
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                INT1 = GNUM (0x02000013)
                SHPO (0x02000013, One)
            }
            ...
            {
                UDB0 ("#####ALSD._CRS\n")
                Return (ConcatenateResTemplate (CRS1, CRS2))
            }
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                ...
                {
                    UDB0 ("#####ALSD._DSM: guid matches\n")
                    If ((Arg2 == Zero))
                    {
                        UDB0 ("#####ALSD._DSM: function 0\n")
                        Return (Buffer (One)
                        {
                             0x03                                             // .
                        })
                    ...
                    If ((Arg2 == One))
                    {
                        UDB0 ("#####ALSD._DSM: function 1\n")
                        Return ("6,60,0,60,20,100,21,100,8000,500,8001,500,500000*#10.0,10.0,10.0,10.0,1000000.0#")
                    }
                }
    ...
    If ((CPPS >= 0x24))
    {
        Scope (_SB)
        {
            PowerResource (CAMP, 0x00, 0x0000)
            {
                ...
                {
                    ADBG ("CAMP: Camera rails turned ON")
                }

                Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
                {
                    ADBG ("CAMP: Camera rails turned OFF")
                }
            }
        }
        ...
        Scope (_SB.PCI0.I2C2)
        {
            Device (CAMF)
            {
                ...
                Name (_CID, "OVTI9734")  // _CID: Compatible ID
                Name (_DDN, "OV9734-CRDD")  // _DDN: DOS Device Name
                Name (_SUB, "MSHW0073")  // _SUB: Subsystem ID
                ...
                Method (SSDB, 0, Serialized)
                {
                    Name (PAR, Buffer (0x6C)
                    {
                        ...
                        /* 0048 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00,  // ........
        ...
        Scope (_SB.PCI0.I2C2)
        {
            Device (CAM3)
            {
                ...
                Name (_SUB, "MSHW0074")  // _SUB: Subsystem ID
                Name (_UID, "0")  // _UID: Unique ID
                Name (_DEP, Package (0x01)  // _DEP: Dependencies
                {
                    SKC2
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.CAM3._CRS.SBUF */
                }
                ...
                Method (SSDB, 0, Serialized)
                {
                    ...
                    Return (PAR) /* \_SB_.PCI0.I2C2.CAM3.SSDB.PAR_ */
                }
            ...
            Device (SKC2)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.PCI0.I2C2.SKC2._CRS.SBUF */
                }
                ...
                Method (CLDB, 0, Serialized)
                {
                    ...
                    Return (PAR) /* \_SB_.PCI0.I2C2.SKC2.CLDB.PAR_ */
                }
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (PA01)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If ((GGIV (0x02050015) == One))
                {
                    If ((0x00040000 == (EBID & 0x00040000)))
                    {
                        Return (Zero)
                    }
                }
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (PA05)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.PCI0.I2C1.PA05._CRS.RBUF */
            }
                ...
                If ((Arg0 == ToUUID ("4993a436-e1ac-4dc7-b4f8-46a5008fb9e7") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == 0x02))
                    {
                        If ((Arg1 == Zero))
                        {
                            ...
                            Return (CBUF) /* \_SB_.PCI0.I2C1.PA05._DSM.CBUF */
                        }
                        Else
                        {
                            Return (Buffer (One)
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (PA06)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.PCI0.I2C1.PA06._CRS.RBUF */
            }
                ...
                If ((Arg0 == ToUUID ("4993a436-e1ac-4dc7-b4f8-46a5008fb9e7") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == 0x02))
                    {
                        If ((Arg1 == Zero))
                        {
                            ...
                            Return (CBUF) /* \_SB_.PCI0.I2C1.PA06._DSM.CBUF */
                        }
                        Else
                        {
                            Return (Buffer (One)
    ...
    Scope (_GPE)
    {
        ...
        Method (_L62, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            If ((GWSI == One))
            {
                ADBG ("Notify Timeandalarm device")
    ...
    Scope (_SB)
    {
        Device (LID0)
        {
            ...
            {
                If ((GGIV (0x02040017) == Zero))
                {
                    SGII (0x02040017, Zero)
                    If (Zero)
                    {
                        LIDS = One
                    }
