 ...
 *
 * Disassembly of ssdt2.dat, Sat Mar 12 22:55:32 2022
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000F03 (3843)
 *     Revision         0x02
 *     Checksum         0xF2
 *     OEM ID           "OEMST "
 ...
 */
DefinitionBlock ("", "SSDT", 2, "OEMST ", "UsbCTabl", 0x00000003)
{
    ...
    External (_SB_.PCI0.XHC_.RHUB.PLDC, PkgObj)
    ...
    Scope (\_SB)
    {
        Device (UBTC)
        {
            ...
            Device (CR01)
            {
                ...
                {
                    Return (\_SB.PCI0.XHC.RHUB.PLDC) /* External reference */
                }
            }

            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (CRS, \_SB.UBTC._Y07._BAS, CBAS)  // _BAS: Base Address
                    ...
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (0x02)
                        {
                            If (\_SB.PCI0.LPCB.EC0.ECOK)
                            {
                                ...
                                Local0 = \_SB.PCI0.LPCB.EC0.CCI3 /* External reference */
                                CCI3 = Local0
                                If ((Local0 != Zero))
                                {
