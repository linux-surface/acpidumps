 ...
 *
 * Disassembly of ssdt8.dat, Fri Oct 20 22:21:00 2023
 *
...
DefinitionBlock ("", "SSDT", 2, "INTEL ", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            OperationRegion (TNVS, SystemMemory, 0x55B4A000, 0x2F)
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Else
                {
                    CreateDWordField (RES0, \_SB.TPM._Y2D._INT, LIRQ)  // _INT: Interrupts
            ...
            Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
            {
                If ((IRQN != Zero))
                {
                    ...
                    CreateBitField (RES0, \_SB.TPM._Y2D._HE, LTRG)  // _HE_: High-Edge
                    LTRG = ITRG /* \_SB_.TPM_._SRS.ITRG */
                    CreateBitField (Arg0, 0x7A, ILVL)
                    CreateBitField (RES0, \_SB.TPM._Y2D._LL, LLVL)  // _LL_: Low Level
