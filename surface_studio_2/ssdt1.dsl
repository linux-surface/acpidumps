 ...
 *
 * Disassembly of ssdt1.dat, Wed Jan  8 12:23:55 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000030DD (12509)
 *     Revision         0x02
 *     Checksum         0x24
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "RTD3_NH"
 *     OEM Revision     0x00001000 (4096)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20160422 (538313762)
 */
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "RTD3_NH", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.XHC)
    {
        ...
        Method (DUAM, 0, Serialized)
        {
            ...
            If ((\UAMS != Zero))
            {
                \_SB.PCI0.XHC.UPWR = Zero
                If ((XHCV == 0xFFFF))
                {
                    If ((\_SB.PCI0.XHC.USPP & 0x02))
                    {
                        \_SB.PCI0.XHC.RHUB.PX01._OFF ()
                        \_SB.PCI0.XHC.UPWR |= 0x02
                    }

                    If ((\_SB.PCI0.XHC.USPP & 0x04))
                    {
                        \_SB.PCI0.XHC.RHUB.PX02._OFF ()
                        \_SB.PCI0.XHC.UPWR |= 0x04
                    }

                    If ((\_SB.PCI0.XHC.USPP & 0x08))
                    {
                        \_SB.PCI0.XHC.RHUB.PX03._OFF ()
                        \_SB.PCI0.XHC.UPWR |= 0x08
                    }

                    If ((\_SB.PCI0.XHC.USPP & 0x10))
                    {
                        \_SB.PCI0.XHC.RHUB.PX04._OFF ()
                        \_SB.PCI0.XHC.UPWR |= 0x10
                    }
                }
                Else
                {
                    ...
                    If (((HP03 == Zero) && (SP02 == Zero)))
                    {
                        \_SB.PCI0.XHC.RHUB.PX03._OFF ()
                        \_SB.PCI0.XHC.UPWR |= 0x08
                    }

                    If (((HP04 == Zero) && (SP03 == Zero)))
                    {
                        \_SB.PCI0.XHC.RHUB.PX04._OFF ()
                        \_SB.PCI0.XHC.UPWR |= 0x10
                    }
            ...
            Else
            {
                If ((\_SB.PCI0.XHC.UPWR & 0x02))
                {
                    \_SB.PCI0.XHC.RHUB.PX01._ON ()
                }

                If ((\_SB.PCI0.XHC.UPWR & 0x04))
                {
                    \_SB.PCI0.XHC.RHUB.PX02._ON ()
                }

                If ((\_SB.PCI0.XHC.UPWR & 0x08))
                {
                    \_SB.PCI0.XHC.RHUB.PX03._ON ()
                }

                If ((\_SB.PCI0.XHC.UPWR & 0x10))
                {
                    \_SB.PCI0.XHC.RHUB.PX04._ON ()
                }
            }
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB)
    {
        ...
        PowerResource (PX08, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (One)
        ...
        PowerResource (PX09, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (One)
