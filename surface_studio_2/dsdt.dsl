 ...
 *
 * Disassembly of dsdt.dat, Wed Jan  8 12:23:55 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001784E (96334)
 *     Revision         0x02
 *     Checksum         0xC3
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    External (BSP1, UnknownObj)
    External (BSP2, UnknownObj)
    External (BSP3, UnknownObj)
    External (BSP4, UnknownObj)
    External (BSP5, UnknownObj)
    External (BSP6, UnknownObj)
    External (BSP7, UnknownObj)
    External (BSP8, UnknownObj)
    External (D1F0, UnknownObj)
    External (D1F1, UnknownObj)
    External (D1F2, UnknownObj)
    External (DGCX, UnknownObj)
    External (DIDX, UnknownObj)
    External (GC6M, UnknownObj)
    ...
    External (P0AP, UnknownObj)
    External (P0LD, UnknownObj)
    External (P0LS, UnknownObj)
    External (P0LT, UnknownObj)
    External (P0RM, UnknownObj)
    External (P0TR, UnknownObj)
    External (P0VC, UnknownObj)
    ...
    External (Q0L0, UnknownObj)
    External (Q0L2, UnknownObj)
    ...
    Name (SS3, Zero)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8EEB9000, 0x077C)
    ...
    Scope (_SB.PCI0.I2C0)
    {
        Device (NXPA)
        {
            Name (_HID, "MSHW0083")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    I2cSerialBusV2 (0x0037, ControllerInitiated, 0x00061A80,
                ...
                Return (RBUF) /* \_SB_.PCI0.I2C0.NXPA._CRS.RBUF */
            }
        }
    }
        ...
        Device (MTKC)
        {
            PowerResource (PRMK, 0x00, 0x0000)
            {
                ...
                Method (_ON, 0, Serialized)  // _ON_: Power On
                {
                    ...
                    {
                        UDB0 ("TAM_MTK_ON\n")
                        \_SB._SAN.RQST (0x18, 0x15, Zero, Zero, One)
                        Sleep (0xC8)
                        _STA = One
                    }
                }
                ...
                Method (_OFF, 0, Serialized)  // _OFF: Power Off
                {
                    ...
                    {
                        UDB0 ("TAM_MTK_OFF\n")
                        \_SB._SAN.RQST (0x18, 0x16, Zero, Zero, One)
                        Sleep (0xC8)
                        _STA = Zero
                    }
                }
                ...
                {
                    UDB0 ("TAM_MTK_OFF_ON\n")
                    \_SB._SAN.RQST (0x18, 0x14, Zero, Zero, One)
                    Sleep (0xC8)
                    _STA = One
                }
            }
    ...
    Scope (_SB.PCI0.RP04.PXSX)
    {
        PowerResource (PRWF, 0x05, 0x0000)
        {
            ...
            Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
            {
                If ((_STA == One))
                {
                    SGOV (0x01050011, Zero)
                    Sleep (0x96)
                    SGOV (0x01050010, Zero)
                    Sleep (0x64)
                    _STA = Zero
                }
            }
    ...
    Scope (_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            If ((GGIV (0x01020015) == Zero))
            {
                UDB0 ("GETS() return 0x01\n")
                Return (One)
            }
            Else
            {
                UDB0 ("GETS() return 0x03\n")
                Return (0x03)
            }
        }
        ...
        Method (MGPS, 4, Serialized)
        {
            Switch (Arg2)
            {
                ...
                Case (0x20)
                {
                    ...
                    Name (RET1, Zero)
                    RET1 |= 0x00800000
                    Return (RET1) /* \_SB_.PCI0.PEG0.PEGP.MGPS.RET1 */
                }
                Case (0x21)
                {
                ...
                Case (0x22)
                {
                    ...
                    \_PR.CPPC = PCAP /* \_SB_.PCI0.PEG0.PEGP.MGPS.PCAP */
                    ...
                    PSAP = PCAP /* \_SB_.PCI0.PEG0.PEGP.MGPS.PCAP */
                    Return (PCAP) /* \_SB_.PCI0.PEG0.PEGP.MGPS.PCAP */
                }
                Case (0x23)
                {
        ...
        Method (MGC6, 4, Serialized)
        {
            Switch (Arg2)
            {
                ...
                Case (One)
                {
                    ...
                    JTC5 = One
                    JTC6 = 0x0103
                    Return (JTFC) /* \_SB_.PCI0.PEG0.PEGP.MGC6.JTFC */
                }
                Case (0x03)
                {
                    UDB0 ("GC6 DSM: JT_FUNC_POWERCONTROL\n")
                    ...
                    If ((ToInteger (DFGC) != Zero))
                    {
                        GPGS = One
                        GUPS = One
                        Return (JTB3) /* \_SB_.PCI0.PEG0.PEGP.MGC6.JTB3 */
                    }
                    ...
                    Switch (GUPC)
                    {
                        Case (Zero)
                        {
                            ...
                            Local0 = BAR0 /* \_SB_.PCI0.PEG0.BAR0 */
                            Local0 += 0x0008A15C
                            DBRN = Local0
                            OperationRegion (REFE, SystemMemory, DBRN, 0x04)
                            Field (REFE, DWordAcc, NoLock, Preserve)
                            {
                                HAFF,   32
                            }
                            ...
                            Sleep (0x0A)
                            HAFF = 0xC0000004
                            WAFU = HDID /* \_SB_.PCI0.PEG0.PEGP.HDID */
                            Return (JTB3) /* \_SB_.PCI0.PEG0.PEGP.MGC6.JTB3 */
                        }
                        Case (One)
                        {
                            UDB0 ("GC6 DSM: GUPC Switch: 1\n")
                            GC6E ()
                            PLST = One
                            Return (JTB3) /* \_SB_.PCI0.PEG0.PEGP.MGC6.JTB3 */
                        }
                        ...
                        Case (0x05)
                        {
                            UDB0 ("GC6 DSM: GUPC Switch: 5\n")
                            Return (0x80000002)
                        }
                        Case (0x06)
                        {
                            UDB0 ("GC6 DSM: GUPC Switch: 6\n")
                            Return (JTB3) /* \_SB_.PCI0.PEG0.PEGP.MGC6.JTB3 */
                        }
        ...
        Method (GOBL, 1, Serialized)
        {
            Name (GSSK, Buffer (0xCC)
            {
                /* 0000 */  0x6A, 0xCC, 0xCE, 0x1C, 0x40, 0x26, 0x6C, 0x5D,  // j...@&l]
                /* 0008 */  0x4B, 0x56, 0xCC, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
                /* 0010 */  0x39, 0x33, 0x38, 0x35, 0x36, 0x39, 0x30, 0x32,  // 93856902
                /* 0018 */  0x37, 0x33, 0x34, 0x31, 0x47, 0x65, 0x6E, 0x75,  // 7341Genu
                /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
                /* 0028 */  0x49, 0x41, 0x20, 0x43, 0x65, 0x72, 0x74, 0x69,  // IA Certi
                /* 0030 */  0x66, 0x69, 0x65, 0x64, 0x20, 0x41, 0x6C, 0x6C,  // fied All
                /* 0038 */  0x2D, 0x49, 0x6E, 0x2D, 0x4F, 0x6E, 0x65, 0x20,  // -In-One 
                /* 0040 */  0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72, 0x6D,  // Platform
                /* 0048 */  0x20, 0x66, 0x6F, 0x72, 0x20, 0x32, 0x30, 0x30,  //  for 200
                /* 0050 */  0x31, 0x35, 0x32, 0x38, 0x37, 0x30, 0x20, 0x20,  // 152870  
                /* 0058 */  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,  //         
                /* 0060 */  0x20, 0x20, 0x2D, 0x20, 0x51, 0x5B, 0x3B, 0x46,  //   - Q[;F
                /* 0068 */  0x40, 0x32, 0x4C, 0x37, 0x53, 0x5C, 0x3F, 0x36,  // @2L7S\?6
                /* 0070 */  0x2A, 0x3D, 0x52, 0x29, 0x45, 0x41, 0x54, 0x50,  // *=R)EATP
                /* 0078 */  0x33, 0x20, 0x4A, 0x56, 0x4D, 0x42, 0x2B, 0x58,  // 3 JVMB+X
                /* 0080 */  0x5A, 0x29, 0x47, 0x35, 0x20, 0x2D, 0x20, 0x43,  // Z)G5 - C
                /* 0088 */  0x6F, 0x70, 0x79, 0x72, 0x69, 0x67, 0x68, 0x74,  // opyright
                /* 0090 */  0x20, 0x32, 0x30, 0x31, 0x34, 0x20, 0x4E, 0x56,  //  2014 NV
                /* 0098 */  0x49, 0x44, 0x49, 0x41, 0x20, 0x43, 0x6F, 0x72,  // IDIA Cor
                /* 00A0 */  0x70, 0x6F, 0x72, 0x61, 0x74, 0x69, 0x6F, 0x6E,  // poration
                /* 00A8 */  0x20, 0x41, 0x6C, 0x6C, 0x20, 0x52, 0x69, 0x67,  //  All Rig
                /* 00B0 */  0x68, 0x74, 0x73, 0x20, 0x52, 0x65, 0x73, 0x65,  // hts Rese
                /* 00B8 */  0x72, 0x76, 0x65, 0x64, 0x2D, 0x39, 0x33, 0x38,  // rved-938
                /* 00C0 */  0x35, 0x36, 0x39, 0x30, 0x32, 0x37, 0x33, 0x34,  // 56902734
                /* 00C8 */  0x31, 0x28, 0x52, 0x29                           // 1(R)
            })
            Name (GXSK, Buffer (0xCC)
            {
                /* 0000 */  0xC8, 0x23, 0xCC, 0xE0, 0xE1, 0x03, 0x51, 0x98,  // .#....Q.
                /* 0008 */  0x4B, 0x56, 0xCC, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
                /* 0010 */  0x39, 0x33, 0x38, 0x35, 0x36, 0x39, 0x30, 0x32,  // 93856902
                /* 0018 */  0x37, 0x33, 0x34, 0x31, 0x47, 0x65, 0x6E, 0x75,  // 7341Genu
                /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
                ...
                /* 0068 */  0x40, 0x32, 0x4C, 0x37, 0x53, 0x5C, 0x3F, 0x36,  // @2L7S\?6
                /* 0070 */  0x2A, 0x3D, 0x52, 0x29, 0x45, 0x41, 0x54, 0x50,  // *=R)EATP
                /* 0078 */  0x33, 0x20, 0x4A, 0x58, 0x4D, 0x42, 0x2B, 0x58,  // 3 JXMB+X
                /* 0080 */  0x5A, 0x29, 0x47, 0x35, 0x20, 0x2D, 0x20, 0x43,  // Z)G5 - C
                /* 0088 */  0x6F, 0x70, 0x79, 0x72, 0x69, 0x67, 0x68, 0x74,  // opyright
                /* 0090 */  0x20, 0x32, 0x30, 0x31, 0x34, 0x20, 0x4E, 0x56,  //  2014 NV
                /* 0098 */  0x49, 0x44, 0x49, 0x41, 0x20, 0x43, 0x6F, 0x72,  // IDIA Cor
            ...
            Name (G1SK, Buffer (0xCC)
            {
                /* 0000 */  0x5A, 0x64, 0x0E, 0xB7, 0xF6, 0x94, 0x0D, 0x39,  // Zd.....9
                /* 0008 */  0x4B, 0x56, 0xCC, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
                /* 0010 */  0x39, 0x33, 0x38, 0x35, 0x36, 0x39, 0x30, 0x32,  // 93856902
                /* 0018 */  0x37, 0x33, 0x34, 0x31, 0x47, 0x65, 0x6E, 0x75,  // 7341Genu
                /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
                ...
                /* 0038 */  0x2D, 0x49, 0x6E, 0x2D, 0x4F, 0x6E, 0x65, 0x20,  // -In-One 
                /* 0040 */  0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72, 0x6D,  // Platform
                /* 0048 */  0x20, 0x66, 0x6F, 0x72, 0x20, 0x4D, 0x53, 0x46,  //  for MSF
                /* 0050 */  0x54, 0x20, 0x49, 0x42, 0x49, 0x53, 0x2D, 0x56,  // T IBIS-V
                /* 0058 */  0x32, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,  // 2       
                /* 0060 */  0x20, 0x20, 0x2D, 0x20, 0x4E, 0x48, 0x28, 0x4B,  //   - NH(K
                /* 0068 */  0x4B, 0x21, 0x3A, 0x24, 0x40, 0x49, 0x2C, 0x3B,  // K!:$@I,;
                /* 0070 */  0x57, 0x2A, 0x41, 0x5C, 0x33, 0x4E, 0x59, 0x27,  // W*A\3NY'
                /* 0078 */  0x3E, 0x23, 0x29, 0x4F, 0x3B, 0x30, 0x56, 0x4D,  // >#)O;0VM
                /* 0080 */  0x47, 0x56, 0x31, 0x22, 0x20, 0x2D, 0x20, 0x43,  // GV1" - C
                /* 0088 */  0x6F, 0x70, 0x79, 0x72, 0x69, 0x67, 0x68, 0x74,  // opyright
                /* 0090 */  0x20, 0x32, 0x30, 0x31, 0x34, 0x20, 0x4E, 0x56,  //  2014 NV
                /* 0098 */  0x49, 0x44, 0x49, 0x41, 0x20, 0x43, 0x6F, 0x72,  // IDIA Cor
                /* 00A0 */  0x70, 0x6F, 0x72, 0x61, 0x74, 0x69, 0x6F, 0x6E,  // poration
            ...
            Name (G2SK, /**** Is ResourceTemplate, but EndTag not at buffer end ****/ Buffer (0xCC)
            {
                /* 0000 */  0x79, 0x75, 0xA0, 0x26, 0x5A, 0x6A, 0x2F, 0x0F,  // yu.&Zj/.
                /* 0008 */  0x4B, 0x56, 0xCC, 0x00, 0x00, 0x00, 0x01, 0x00,  // KV......
                /* 0010 */  0x39, 0x33, 0x38, 0x35, 0x36, 0x39, 0x30, 0x32,  // 93856902
                /* 0018 */  0x37, 0x33, 0x34, 0x31, 0x47, 0x65, 0x6E, 0x75,  // 7341Genu
                /* 0020 */  0x69, 0x6E, 0x65, 0x20, 0x4E, 0x56, 0x49, 0x44,  // ine NVID
                ...
                /* 0040 */  0x50, 0x6C, 0x61, 0x74, 0x66, 0x6F, 0x72, 0x6D,  // Platform
                /* 0048 */  0x20, 0x66, 0x6F, 0x72, 0x20, 0x4D, 0x53, 0x46,  //  for MSF
                /* 0050 */  0x54, 0x20, 0x49, 0x42, 0x49, 0x53, 0x56, 0x32,  // T IBISV2
                /* 0058 */  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,  //         
                /* 0060 */  0x20, 0x20, 0x2D, 0x20, 0x51, 0x5B, 0x3B, 0x46,  //   - Q[;F
                /* 0068 */  0x44, 0x32, 0x4C, 0x37, 0x53, 0x5C, 0x3F, 0x36,  // D2L7S\?6
                /* 0070 */  0x2A, 0x3D, 0x52, 0x29, 0x45, 0x41, 0x54, 0x50,  // *=R)EATP
                /* 0078 */  0x33, 0x51, 0x4F, 0x5D, 0x4D, 0x42, 0x2B, 0x58,  // 3QO]MB+X
                /* 0080 */  0x5A, 0x29, 0x47, 0x35, 0x20, 0x2D, 0x20, 0x43,  // Z)G5 - C
                /* 0088 */  0x6F, 0x70, 0x79, 0x72, 0x69, 0x67, 0x68, 0x74,  // opyright
                /* 0090 */  0x20, 0x32, 0x30, 0x31, 0x34, 0x20, 0x4E, 0x56,  //  2014 NV
                /* 0098 */  0x49, 0x44, 0x49, 0x41, 0x20, 0x43, 0x6F, 0x72,  // IDIA Cor
            ...
            If ((USRG == 0x564B))
            {
                If ((NDID == 0x13D9))
                {
                    Return (GSSK) /* \_SB_.PCI0.PEG0.PEGP.GOBL.GSSK */
                }

                If ((NDID == 0x13D7))
                {
                    Return (GXSK) /* \_SB_.PCI0.PEG0.PEGP.GOBL.GXSK */
                }

                If ((NDID == 0x1C23))
                {
                    Return (G1SK) /* \_SB_.PCI0.PEG0.PEGP.GOBL.G1SK */
                }

                If ((NDID == 0x1BA2))
                {
                    Return (G2SK) /* \_SB_.PCI0.PEG0.PEGP.GOBL.G2SK */
                }
            }
    ...
    Scope (_SB.PCI0.PEG0)
    {
        ...
        OperationRegion (NVHD, SystemMemory, 0xE0101000, 0x1000)
        Field (NVHD, DWordAcc, Lock, Preserve)
        {
            Offset (0x40), 
            WAFU,   32
        }
        ...
        PowerResource (PRNV, 0x00, 0x0000)
        {
            Name (_STA, One)  // _STA: Status
            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                ...
                If ((TDGC == One))
                {
                    UDB0 ("PRNV._ON: Defered GC6\n")
                    If ((DGCX == 0x03))
                    {
                        UDB0 ("PRNV._ON: Calling GC6D\n")
                        ^^PEGP.GC6D ()
                    }
            ...
            Method (_OFF, 0, Serialized)  // _OFF: Power Off
            {
                ...
                If ((TDGC == One))
                {
                    UDB0 ("PRNV._OFF: Deferred GC6 exit\n")
                    CreateField (^^PEGP.TGPC, Zero, 0x03, GUPC)
                    If ((ToInteger (GUPC) == One))
                    {
                        UDB0 ("PRNV._OFF: Calling GC6E (1)\n")
                        ^^PEGP.GC6E ()
                    }
                    ElseIf ((ToInteger (GUPC) == 0x02))
                    {
                        UDB0 ("PRNV._OFF: Calling GC6E (2)\n")
                        ^^PEGP.GC6E ()
                    }
                }
                Else
                {
                    UDB0 ("PRNV._OFF: Calling HGOF\n")
                    HGOF ()
                }
            }
        }
        ...
        Method (NGOV, 2, Serialized)
        {
            OperationRegion (PDW0, SystemMemory, 0xFDAE0698, 0x04)
            Field (PDW0, AnyAcc, NoLock, Preserve)
            {
                TEMP,   1, 
                Offset (0x04)
        ...
        Method (HGON, 0, Serialized)
        {
            ...
            If ((GVID != 0xFFFFFFFF))
            {
                UDB0 ("HGON: link already up, returning without executing\n")
                GC6M = Zero
                Return (Zero)
            }
            ...
            SGOV (0x01010010, One)
            Local0 = Zero
            Local1 = GGIV (0x0102000E)
            While ((Local1 == Zero))
            {
                Local1 = GGIV (0x0102000E)
                If ((Local0 >= 0x64))
                {
                    UDB0 ("HGON: ERROR: Timed out waiting for DGPU Power Good turn on\n")
                    Return (Zero)
                }
            ...
            While ((Local0 == One))
            {
                ...
                If ((Local1 == 0x03))
                {
                    UDB0 ("HGON: ERROR: Failed to enable link. PGEN timedout after 3 retries.\n")
                    Return (Zero)
                }
            }
            ...
            OperationRegion (TEFG, SystemMemory, 0xE0008020, 0x04)
            Field (TEFG, DWordAcc, NoLock, Preserve)
            {
                QEFG,   32
            }

            QEFG = ^PEGP.ROT0 /* \_SB_.PCI0.PEG0.PEGP.ROT0 */
            OperationRegion (KEFG, SystemMemory, 0xE0008004, One)
            Field (KEFG, ByteAcc, NoLock, Preserve)
            {
                WAKZ,   8
            }

            WAKZ = 0x07
            OperationRegion (WEFG, SystemMemory, 0xE0100010, 0x04)
            Field (WEFG, DWordAcc, NoLock, Preserve)
            {
                WAFW,   32
            }

            WAFW = ^PEGP.DBR1 /* \_SB_.PCI0.PEG0.PEGP.DBR1 */
            Name (DBRM, Zero)
            OperationRegion (ZEFG, SystemMemory, 0xE0100004, One)
            Field (ZEFG, ByteAcc, NoLock, Preserve)
            {
                WAFZ,   8
            }

            DBRM = WAFZ /* \_SB_.PCI0.PEG0.HGON.WAFZ */
            WAFZ = 0x06
            OperationRegion (RZZS, SystemMemory, ^PEGP.DBRN, 0x04)
            Field (RZZS, DWordAcc, NoLock, Preserve)
            {
                HZZF,   32
            }
            ...
            Sleep (0x0A)
            HZZF = 0xC0000004
            WAFU = ^PEGP.HDID /* \_SB_.PCI0.PEG0.PEGP.HDID */
            WAFZ = DBRM /* \_SB_.PCI0.PEG0.HGON.DBRM */
        }
        ...
        Method (HGOF, 0, Serialized)
        {
            ...
            While ((Local0 == One))
            {
                ...
                If ((Local1 == 0x03))
                {
                    UDB0 ("GC6E: ERROR: Failed to disable link. PGDS timedout after 3 retries.\n")
                    Return (Zero)
                }
            }

            SGOV (0x01050016, Zero)
            Sleep (0x64)
            Name (SCLK, Package (0x03)
            {
                One, 
            ...
            While ((Local1 == One))
            {
                ...
                If ((Local0 >= 0x64))
                {
                    UDB0 ("HGOF: ERROR: Timed out waiting for DGPU Power Good to turn off\n")
                    Return (Zero)
                }
        ...
        Method (PGEN, 0, Serialized)
        {
            ...
            UDB0 ("PGEN: Timed out waiting for P0VC.\n")
            Return (One)
        }

        Method (PGDS, 0, Serialized)
        {
            P0LD = One
            Local0 = Zero
            While ((Local0 < 0x012C))
            ...
            If ((P0LT != 0x08))
            {
                UDB0 ("PGDS: Timed out waiting for P0LT.\n")
                Return (One)
            }
    ...
    Scope (_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            UDB0 ("_SB_.PCI0.PEG0.PEG _PS1\n")
        }

        Method (_PS3, 0, NotSerialized)  // _PS3: Power State 3
        {
            UDB0 ("_SB_.PCI0.PEG0.PEG _PS3\n")
            If ((OPCE == 0x03))
            {
                If ((DGPS == Zero))
                {
        ...
        Method (_ON, 0, Serialized)  // _ON_: Power On
        {
            UDB0 ("_SB_.PCI0.PEG0.PEG _ON\n")
            HGON ()
            Sleep (0x64)
            If ((GPRF != One))
            {
                Local0 = NCMD /* \_SB_.PCI0.PEG0.PEGP.NCMD */
                NCMD = Zero
        ...
        {
            Local0 = BAR0 /* \_SB_.PCI0.PEG0.BAR0 */
            DBR1 = BAR0 /* \_SB_.PCI0.PEG0.BAR0 */
            Local0 += 0x0008A15C
            DBRN = Local0
            OperationRegion (REGE, SystemMemory, DBRN, 0x04)
            SGOV (0x01020016, One)
            Field (REGE, DWordAcc, NoLock, Preserve)
            {
                HADT,   32
            }
            ...
            ROT0 = QEFG /* \_SB_.PCI0.PEG0.PEGP._INI.QEFG */
            HDID = WAFU /* \_SB_.PCI0.PEG0.WAFU */
        }
        ...
        {
            Local0 = Zero
            While ((GGIV (0x01020015) != Arg0))
            {
                If ((Local0 == 0x03E8))
                {
                    UDB0 ("WGFE: ERROR : Wait for GPIO_PIN__GPU_GC6_FB_EN Timeout\n")
                    Return (One)
                }
        ...
        Method (GC6E, 0, Serialized)
        {
            ...
            If ((GC6M != Zero))
            {
                UDB0 ("GC6E: ERROR: Current state of GC6 is not disabled\n")
                Return (Zero)
            }

            Local0 = One
            Local1 = Zero
            LTRB = LREN /* \_SB_.PCI0.PEG0.PEGP.LREN */
            While ((Local0 == One))
            {
                Local0 = PGDS ()
                Local1 += One
        ...
        Method (GC6D, 0, Serialized)
        {
            ...
            If ((GC6M != One))
            {
                UDB0 ("GC6D: Current state of GC6 is not enabled\n")
                Return (Zero)
            }

            SGOV (0x01020016, Zero)
            Sleep (One)
            Local0 = WGFE (Zero)
            SGOV (0x01020016, One)
            Sleep (0x64)
            ...
            GC6M = Zero
            ^^PRNV._STA = One
            LREN = LTRB /* \_SB_.PCI0.PEG0.PEGP.LTRB */
            ^^CEDR = One
            Sleep (0x64)
        }

        Name (ESHL, Buffer (0x0100)
        {
            /* 0000 */  0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00,  // ........
            /* 0008 */  0x4D, 0x10, 0x98, 0x14, 0x00, 0x00, 0x0D, 0x00,  // M.......
            /* 0010 */  0x28, 0x1B, 0x01, 0x04, 0xB5, 0x3C, 0x28, 0x78,  // (....<(x
            /* 0018 */  0x06, 0x3E, 0x40, 0xAE, 0x51, 0x43, 0xB0, 0x26,  // .>@.QC.&
            /* 0020 */  0x0D, 0x50, 0x54, 0x00, 0x00, 0x00, 0x01, 0x01,  // .PT.....
            /* 0028 */  0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,  // ........
            /* 0030 */  0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x4F, 0xAE,  // ......O.
            /* 0038 */  0xCA, 0xA0, 0x80, 0xB8, 0x56, 0xB0, 0x08, 0x20,  // ....V.. 
            /* 0040 */  0x8E, 0x0C, 0x53, 0x8D, 0x21, 0x00, 0x00, 0x18,  // ..S.!...
            /* 0048 */  0x00, 0x00, 0x00, 0x10, 0x00, 0xB8, 0x6D, 0xB1,  // ......m.
            /* 0050 */  0x08, 0x20, 0xE8, 0x0C, 0x53, 0x8D, 0x21, 0x00,  // . ..S.!.
            /* 0058 */  0x00, 0x18, 0x00, 0x00, 0x00, 0xFE, 0x00, 0x53,  // .......S
            /* 0060 */  0x48, 0x50, 0x0A, 0x20, 0x20, 0x20, 0x20, 0x20,  // HP.     
            /* 0068 */  0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0xFE,  //     ....
            /* 0070 */  0x00, 0x4C, 0x51, 0x32, 0x38, 0x32, 0x44, 0x31,  // .LQ282D1
            /* 0078 */  0x4A, 0x43, 0x30, 0x31, 0x0A, 0x20, 0x01, 0x47,  // JC01. .G
            /* 0080 */  0x70, 0x13, 0x19, 0x02, 0x00, 0x12, 0x00, 0x16,  // p.......
            /* 0088 */  0x80, 0x10, 0x00, 0x00, 0xC9, 0x08, 0xB7, 0x0B,  // ........
            /* 0090 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x48, 0x50,  // .....SHP
            /* 0098 */  0x98, 0x14, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x00,  // ........
        ...
        Name (ESHR, Buffer (0x0100)
        {
            ...
            /* 0078 */  0x4A, 0x43, 0x30, 0x31, 0x0A, 0x20, 0x01, 0x47,  // JC01. .G
            /* 0080 */  0x70, 0x13, 0x19, 0x02, 0x00, 0x12, 0x00, 0x16,  // p.......
            /* 0088 */  0x80, 0x10, 0x10, 0x00, 0xC9, 0x08, 0xB7, 0x0B,  // ........
            /* 0090 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x48, 0x50,  // .....SHP
            /* 0098 */  0x98, 0x14, 0x00, 0x00, 0x00, 0x00, 0xE0, 0x00,  // ........
            /* 00A0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 00A8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 00B0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 00B8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
        ...
        Device (EDP1)
        {
            ...
            {
                UDB0 ("NvidiaGraphics : EDP1 _DDC\n")
                Return (ESHL) /* \_SB_.PCI0.PEG0.PEGP.ESHL */
            }
            ...
            {
                Return (NVBR) /* \_SB_.PCI0.PEG0.PEGP.NVBR */
            }
        }
        ...
        Device (EDP2)
        {
            ...
            Method (_DDC, 1, NotSerialized)  // _DDC: Display Data Current
            {
                UDB0 ("NvidiaGraphics : EDP2 _DDC\n")
                Return (ESHR) /* \_SB_.PCI0.PEG0.PEGP.ESHR */
            }
        ...
        OperationRegion (OROM, SystemMemory, OADR, OSIZ)
        Field (OROM, DWordAcc, NoLock, Preserve)
        {
            RBF1,   262144, 
            RBF2,   262144, 
            RBF3,   262144, 
        ...
        Method (_ROM, 2, Serialized)  // _ROM: Read-Only Memory
        {
            ...
            {
                Local0 -= 0x00030000
                ROM1 = RBF7 /* \_SB_.PCI0.PEG0.PEGP.RBF7 */
            }
            ElseIf ((Local0 < 0x00040000))
            {
                Local0 -= 0x00038000
                ROM1 = RBF8 /* \_SB_.PCI0.PEG0.PEGP.RBF8 */
            }
    ...
    Scope (_SB)
    {
        Device (PEPD)
        {
            ...
            {
                UDB0 ("uPEP DSM: Entry\n")
                UDB1 ("uPEP DSM: PEPC = %0X\n", PEPC)
                If ((Arg0 == ToUUID ("c4eb40a0-6cd2-11e2-bcfd-0800200c9a66")))
                {
                    If ((Arg2 == Zero))
                    {
                        UDB0 ("uPEP DSM: Function 0\n")
                        Return (Buffer (One)
                        {
                             0x7F                                             // .
                        })
                    ...
                    If ((Arg2 == One))
                    {
                        UDB0 ("uPEP DSM: Function 1: Entry\n")
                        If ((S0ID == Zero))
                        {
                            Return (Package (0x00){})
                        }
                        ...
                        UDB0 ("uPEP DSM: Function 1: Return DEVY\n")
