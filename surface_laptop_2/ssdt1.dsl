 ...
 *
 * Disassembly of ssdt1.dat, Sun Jan 19 00:46:38 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000281D (10269)
 *     Revision         0x02
 *     Checksum         0x9E
 *     OEM ID           "MSFT  "
...
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "RTD3APNV", 0x00001000)
{
    ...
    External (_SB_.PCI0.RP07.PXSX.PAHC, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.RP07.PXSX.PNVM, MethodObj)    // 0 Arguments
    ...
    Scope (\_SB.PCI0.RP07.PXSX)
    {
        ...
        Method (_PR0, 0, NotSerialized)  // _PR0: Power Resources for D0
        {
            If ((PAHC () || PNVM ()))
            {
                ...
                ElseIf (CondRefOf (\_SB.PCI0.RP07.PXP))
                {
                    Return (Package (0x01)
                    {
                        \_SB.PCI0.RP07.PXP
    ...
    Scope (\_SB.PCI0.XHC.RHUB)
    {
        ...
        PowerResource (PX10, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (One)
