 ...
 *
 * Disassembly of dsdt.dat, Sun Jan 19 00:46:38 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000171A9 (94633)
 *     Revision         0x02
 *     Checksum         0xF7
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    Name (SS3, Zero)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8BEA1000, 0x077C)
    ...
    Scope (_SB.PCI0.I2C3)
    {
        Device (ALSD)
        {
            ...
            {
                UDB0 ("#####ALSD._DSM\n")
                If ((Arg0 == ToUUID ("b310de34-f4b4-444e-813a-e694ff921fe2")))
                {
