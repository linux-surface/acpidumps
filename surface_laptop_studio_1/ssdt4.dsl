 ...
 *
 * Disassembly of ssdt4.dat, Sat Oct  9 15:47:08 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00002ABB (10939)
 *     Revision         0x02
 *     Checksum         0xB6
 *     OEM ID           "MSFT  "
...
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "SsdtGpu", 0x00001000)
{
                        ...
                        Switch (ToInteger (Arg2))
                        {
                            ...
                            Case (0x07)
                            {
                                ...
                                If ((ToInteger (Arg3) > Zero))
                                {
                                    ...
                                    SPWR = 0x0230
                                    UDB0 ("[SGPC.ENABLED]\n")
                                    Notify (\_SB.PC00.RP09.PXSX, 0xD1) // Hardware-Specific
                                }
                                Else
                                {
                                    SACT = Zero
                                    ...
                                    SPWR = Zero
                                    UDB0 ("[SGPC.DISABLED]\n")
                                    Notify (\_SB.PC00.RP09.PXSX, 0xD5) // Hardware-Specific
                                }
    ...
    Scope (\_SB.PC00.RP09.PXSX)
    {
        ...
        Method (MGPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x22)
                {
                    ...
                    \_SB.CPPC = PCAP /* \_SB_.PC00.RP09.PXSX.MGPS.PCAP */
                    ...
                    PSAP = PCAP /* \_SB_.PC00.RP09.PXSX.MGPS.PCAP */
                    Return (PCAP) /* \_SB_.PC00.RP09.PXSX.MGPS.PCAP */
                }
                Case (0x23)
                {
                    UDB0 ("[HG._DSM.GPS] - GPS_FUNC_GETPPC\n")
                    Return (PSAP) /* \_SB_.PC00.RP09.PXSX.PSAP */
                }
                Case (0x2A)
                {
                    ...
                    Switch (ToInteger (PSH0))
                    {
                        Case (Zero)
                        {
                            ...
                            Return (GPSP) /* \_SB_.PC00.RP09.PXSX.GPSP */
                        }
                        Case (One)
                        {
                            RETN = One
        ...
        Method (MGC6, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (One)
                {
                    ...
                    GC6V = 0x02
                    JTRV = 0x0200
                    Return (JTCA) /* \_SB_.PC00.RP09.PXSX.MGC6.JTCA */
                }
                Case (0x03)
                {
                    UDB0 ("[HG._DSM.GC6] - JT_FUNC_POWERCONTROL\n")
                    ADBG ("JT fun3 JT_FUNC_POWERCONTROL")
                    ...
                    If ((ToInteger (DFGC) != Zero))
                    {
                        GPWO = One
                        GUPS = One
                        Return (JTPC) /* \_SB_.PC00.RP09.PXSX.MGC6.JTPC */
                    }

                    UDB1 ("[HG._DSM.GC6] - JT_FUNC_POWERCONTROL GUPC=%0X\n", ToInteger (GUPC))
                    ADBG ("JT fun3 GUPC=")
                    ADBG (ToString (GUPC, Ones))
                    ...
                    ElseIf ((\_SB.GGIV (0x0907000D) == Zero))
                    {
                        UDB0 ("[HG._DSM.GC6] - JT_FUNC_POWERCONTROL GETS() return 0x1\n")
                        ADBG ("JT GETS() return 0x1")
                        GPWO = One
                        GUPS = One
                    }
                    Else
        ...
        Method (GC6I, 0, Serialized)
        {
            UDB0 ("[HG.GC6I] - Entry\n")
            ADBG ("JT GC6I")
            TMM1 = \_SB.PC00.RP09.LTME
            \_SB.PC00.RP09.L23I ()
            Sleep (0x0A)
            \_SB.SGOV (0x0907000C, Zero)
        ...
        Method (GC6O, 0, Serialized)
        {
            UDB0 ("[HG.GC6O] - Entry\n")
            ADBG ("JT GC6O")
            \_SB.SGOV (0x0907000C, One)
            Sleep (0x0A)
            \_SB.PC00.RP09.L23O ()
            \_SB.PC00.RP09.CMDR |= 0x04
            \_SB.PC00.RP09.LTME = TMM1 /* \_SB_.PC00.RP09.PXSX.TMM1 */
            \_SB.PC00.RP09.CEDR = One
        ...
        Method (MOPT, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x1B)
                {
                    ...
                    If ((APCV == One))
                    {
                        ACNT = APPC /* \_SB_.PC00.RP09.PXSX.MOPT.APPC */
        ...
        Method (NBCI, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x10)
                {
                    ...
                    If ((BFF0 == 0x4452))
                    {
                        Return (GSDR) /* \_SB_.PC00.RP09.PXSX.GSDR */
                    }
                }
    ...
    Scope (\_SB.PC00.RP09)
    {
        OperationRegion (RPCX, SystemMemory, 0xE00E8000, 0x1000)
        ...
        PowerResource (PRPD, 0x00, 0x0000)
        {
            ...
            {
                UDB2 ("[RP09._ON] Entry: TDGC: %0, DGCX: %1\n", \_SB.PC00.RP09.PXSX.TDGC, \_SB.PC00.RP09.PXSX.DGCX)
                If ((\_SB.PC00.RP09.PXSX.TDGC == One))
                {
                    If (((\_SB.PC00.RP09.PXSX.DGCX == 0x03) || (\_SB.PC00.RP09.PXSX.DGCX == 0x04)))
                    {
                        \_SB.PC00.RP09.PXSX.GC6O ()
                    }

                    \_SB.PC00.RP09.PXSX.TDGC = Zero
                    \_SB.PC00.RP09.PXSX.DGCX = Zero
                }
                Else
                {
                    \_SB.PC00.RP09.HGON ()
            ...
            {
                UDB2 ("[RP09._OFF] Entry: TDGC: %0, TGPC: %1\n", \_SB.PC00.RP09.PXSX.TDGC, \_SB.PC00.RP09.PXSX.TGPC)
                If (ToInteger ((\_SB.SGPC.SACT == One)))
                {
                    Notify (\_SB.SGPC, 0x80) // Status Change
                }
                ...
                If ((\_SB.PC00.RP09.PXSX.TDGC == One))
                {
                    CreateField (\_SB.PC00.RP09.PXSX.TGPC, Zero, 0x03, GUPC)
                    If (((ToInteger (GUPC) == One) || (ToInteger (GUPC) == 0x02)))
                    {
                        \_SB.PC00.RP09.PXSX.GC6I ()
                    }
                }
                Else
                {
        ...
        Method (HGON, 0, Serialized)
        {
            ...
            Else
            {
                \_SB.SGOV (0x0907000C, Zero)
                Sleep (One)
                \_SB.SGOV (0x090C000E, One)
                Sleep (One)
                Local0 = WPGS (0x090C000F, One, 0x0BB8)
                If ((Zero == Local0))
                {
        ...
        Method (HGOF, 0, Serialized)
        {
            ...
            \_SB.SGOV (0x0907000C, Zero)
            Sleep (0x03)
            \_SB.SGOV (0x090C000E, Zero)
            Sleep (0x0A)
            Local0 = WPGS (0x090C000F, Zero, 0x0BB8)
            If ((Zero == Local0))
            {
                UDB1 ("[HGOF] WARNING: Timeout waiting for dGPU to power off, LKS1: %0X\n", LKS1)
            }

            \_SB.PC00.RP09.RLNK = One
