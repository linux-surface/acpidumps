 ...
 *
 * Disassembly of ssdt4.dat, Wed Jun 30 23:35:16 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000012F9 (4857)
 *     Revision         0x02
 *     Checksum         0xFC
 *     OEM ID           "MSFT  "
...
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "SsdtSurf", 0x00001000)
{
    ...
    Scope (\_SB.PC00.XHCI.RHUB.SS04)
    {
        ...
        PowerResource (PWFR, 0x05, 0x0000)
        {
            ...
            {
                \_SB.SGOV (0x09030005, Zero)
                Sleep (0x2AF8)
                \_SB.SGOV (0x09030005, One)
                Sleep (0x2328)
                _STA = One
            }
