 ...
 *
 * Disassembly of dsdt.dat, Wed Jun 30 23:35:16 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001A3C9 (107465)
 *     Revision         0x02
 *     Checksum         0x6A
 *     OEM ID           "INTEL"
 *     OEM Table ID     "TGL     "
...
DefinitionBlock ("", "DSDT", 2, "INTEL", "TGL     ", 0x00000000)
{
    ...
    OperationRegion (FNVS, SystemMemory, 0x96B96000, 0x000F)
    ...
    Scope (\)
    {
        ...
        Name (SS3, Zero)
        Name (SS4, One)
        OperationRegion (GNVS, SystemMemory, 0x96B98000, 0x0A9A)
        ...
        Device (CAMF)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0050 */  0x0C, 0x01, 0x02, 0x01, 0x01, 0x01, 0x00, 0xF8,  // ........
        ...
        Device (CAM3)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0050 */  0x0C, 0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0xF8,  // ........
